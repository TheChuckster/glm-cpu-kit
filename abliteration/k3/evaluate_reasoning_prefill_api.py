#!/usr/bin/env python3
"""Run the frozen K3 V13 reasoning-prefill evaluation through the live API."""
...
def arguments():
    ...
    if args.reasoning_prefill != "I know that.":
        parser.error("reasoning prefill differs from the locked V13 seed")
    return args
