...
The dependency-corrected source smoke generated byte-identical GGUF and JSON
on two independent runs. The final Q5-only capture then completed all 359 rows
and passed every spectral gate before any weight write. Exact SHA-256 values:

- Q5 activation, mean, private log, Python freeze, engine/method closure, and
  complete artifact list: `bea26596b2f01e4cf964015c4d95c52a1f11f876093b6e5a05bbf4e85fa27051`,
  `1f4e6d9e2f036200348df8801c687a524f662f5b9273381c0d382700b6e6c72f`,
  `d7e74409092951ad41572bcd007af9daba159bfd8496fe4e7162c8aad86247c7`,
  `e097ffb5be47316aee396d5b4777fbb232ce648b8e78d9736eac90e9ac9b92d3`,
  `88e7f3432d0c23356868397d42f7f706db6f15ba97b3011df47d492bbf2002e2`,
  and `fb0bf4e7d1dcb93c9df74f9ffc7319995c7123299352b02e1f1e603e2dfd805d`;
- source direction/manifest: `1c9a6fd36433154e3392e1f6168b78fd7983158543b755bc987ed739d5e1ced5`
  and `214e641e951fe529ba3c1e9f102d08d1db21ef4edf6da7539be697c84358919c`;
- Q5 direction/manifest: `3efcac932b42538b862e1b6b4e454f6ee7930737c7fb6cb794c0ab5d7869c7c9`
  and `ce50085977c539c296cb5695df4cc4e6a65f07b8769be69973450d627973dab8`;
- verification JSON: `0ada1e63a2ec3c771358891f0e378f53f0c44b6aeed0d56a67127374d7c9dbd0`.

The seven source-to-Q5 principal cosines are
`0.996705404, 0.996570489, 0.995442961, 0.994844417, 0.994035339,
0.989516496, 0.987164644`; source/Q5 class-mean retention is
`0.999960921/0.999962101`, and maximum reconstructed-basis error is
`1.39e-17`. All gates pass. Accepted v1 was restored and exact API identity
reverified after capture.

Candidate construction is now locked to engine commit
`dd0bf0177f78657960364493d0220350a82548fb`, cvector SHA-256
`47e921423d579806ce455aeedd366d8c471cb73eb5826540d1116471ba7a04b5`,
and quantizer SHA-256
`02ba5e46dc67d4bcb5b154638c29cad7540347c17ef34713e23da56d498f589d`.
Build `/models/Kimi-K3-Q5attn-Abliterated-V5-R2` only through
`build_candidate_v5.sh`: source spectral direction, rank seven, scale 1.0,
the same 279 targets, mandatory reflink patch-existing mode, 64 correction
passes at 0.0625, and maximum residual 0.019. Spectral directions are verified
